...
-- Scenarios table for scenario-based MI training
...
COMMENT ON COLUMN scenarios.persona_config IS 'Full persona configuration';
COMMENT ON COLUMN scenarios.success_criteria IS 'Turn range, required skills, avoid behaviors';
COMMENT ON COLUMN scenarios.maps_rubric IS 'MAPS rubric dimensions with weights';
