...
CREATE TABLE IF NOT EXISTS scenario_attempts (
    ...
    -- Skills and behaviors tracked during attempt
...
COMMENT ON COLUMN scenario_attempts.transcript IS 'Array of turns with manager message, persona response, and analysis';
